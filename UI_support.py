...
# TABS Child frames (SELECT) 30%
TAB_TEST_SELECT_REL_X = TAB_TEST_TYPE_REL_X
TAB_TEST_SELECT_REL_W = TAB_TEST_TYPE_REL_W
TAB_TEST_SELECT_REL_H = 0.30

# SELECT sub elements
# SELECT QUERY H - 15%
TAB_TEST_SELECT_QUERY_REL_X = 0.025
TAB_TEST_SELECT_QUERY_REL_Y = 0.01
TAB_TEST_SELECT_QUERY_REL_W = 0.95
TAB_TEST_SELECT_QUERY_REL_H = 0.13
...
# SELECT LIST BOX H - 70%
TAB_TEST_LISTBOX_QUERY_REL_X = TAB_TEST_SELECT_QUERY_REL_X * 2
TAB_TEST_LISTBOX_QUERY_REL_Y = 0.05
TAB_TEST_LISTBOX_QUERY_REL_W = TAB_TEST_SELECT_QUERY_REL_W - (2 * TAB_TEST_SELECT_QUERY_REL_X)
TAB_TEST_LISTBOX_QUERY_REL_H = 0.60

# SELECT COMMANDS H - 15%
TAB_TEST_COMMANDS_QUERY_REL_X = TAB_TEST_SELECT_QUERY_REL_X
TAB_TEST_COMMANDS_QUERY_REL_Y = TAB_TEST_SELECT_QUERY_REL_Y
TAB_TEST_COMMANDS_QUERY_REL_W = 0.95
TAB_TEST_COMMANDS_QUERY_REL_H = 0.13

# TABS Child frames (FILTER) 45%
TAB_TEST_FILTER_REL_X = TAB_TEST_TYPE_REL_X
TAB_TEST_FILTER_REL_W = TAB_TEST_TYPE_REL_W
TAB_TEST_FILTER_REL_H = 0.45

# TABS Child frames (PROCESS) 15%
TAB_TEST_PROCESS_REL_X = TAB_TEST_TYPE_REL_X
TAB_TEST_PROCESS_REL_W = TAB_TEST_TYPE_REL_W
TAB_TEST_PROCESS_REL_H = 0.18
