...
TAB_TEST_SELECT_LBL_REL_W = 0.3

TAB_TEST_SELECT_ENTRY_REL_W = 0.6
...
TAB_TEST_FILTER_TITLE_REL_H = 0.1 # 25 # Note: This is Height not Relative Height
TAB_TEST_PROCESS_TITLE_REL_H = 0.13 # 25 # Note: This is Height not Relative Height


# FILTER sub elements
TAB_TEST_FILTER_QUERY_REL_W = TAB_TEST_SELECT_QUERY_REL_W * 0.44 # 0.86
TAB_TEST_FILTER_QUERY_REL_X = (1 - TAB_TEST_FILTER_QUERY_REL_W) / 2 # 0.07
TAB_TEST_FILTER_QUERY_REL_Y = 0.04
TAB_TEST_FILTER_QUERY_REL_H = 0.095 # > 1


TAB_TEST_FILTER_QUERY_FEATURE_NAME_REL_H = 0.12 # > 1 # > 2

TAB_TEST_FILTER_LIST_DATA_REL_X = TAB_TEST_SELECT_QUERY_REL_X
TAB_TEST_FILTER_LIST_DATA_REL_W = TAB_TEST_SELECT_QUERY_REL_W
...
TAB_TEST_FILTER_LISTBOX_LIST_REL_H = 0.87 # > 3

TAB_TEST_FILTER_LISTBOX_STATUS_REL_X = 0
TAB_TEST_FILTER_LISTBOX_STATUS_REL_W = 1
TAB_TEST_FILTER_LISTBOX_STATUS_REL_H = 0.13 # > 3

# FILTER QUERY
TAB_TEST_FILTER_QUERY_LBL_REL_X = 0
TAB_TEST_FILTER_QUERY_LBL_REL_Y = 0
TAB_TEST_FILTER_QUERY_LBL_REL_W = TAB_TEST_SELECT_LBL_REL_W

TAB_TEST_FILTER_QUERY_ENTRY_REL_W = TAB_TEST_SELECT_ENTRY_REL_W
TAB_TEST_FILTER_QUERY_BTN_REL_W = 0.1
