...
DEFAULT_BORDER = '#A19C7F'  # R: 161, G: 156, B: 127 # '#B8B395' # R: 184, G: 179, B: 149
DEFAULT_LIGHT_BORDER = '#DFDAB9'  # R: 223, G: 218, B: 185 # '#E8E3C1'  # R: 232, G: 227, B: 193
...
SELECT_LISTBOX_BG = PALER_YELLOW  # The background color in listbox of MM
SELECT_LISTBOX_FG = FG_COLOR
SELECT_LISTBOX_SELECTED_ITEM_BG = DISABLED_ORANGE  # PALE_YELLOW  # The selected item's background from MM listbox
...
PROCESS_ENTRY_SELECT_HIGHLIGHT_BG = PLUM_PURPLE  # Selected text background (highlighted text)
PROCESS_ENTRY_SELECT_INSERT_BG = PLUM_PURPLE  # SELECT_TITLE_BG
PROCESS_ENTRY_BG = WHITE
PROCESS_ENTRY_FG = D_BLUE  # SELECT_TITLE_BG


PROCESS_LISTBOX_STATUS_BG = D_BLUE
PROCESS_LISTBOX_STATUS_FG = WHITE

PROCESS_LABEL_BG = SELECT_LABEL_BG
PROCESS_LABEL_FG = PLUM_PURPLE  # SELECT_LABEL_FG

PROCESS_LISTBOX_BG = SELECT_LISTBOX_BG
PROCESS_LISTBOX_FG = SELECT_LISTBOX_FG

PROCESS_LISTBOX_SELECTED_ITEM_BG = SELECT_LISTBOX_SELECTED_ITEM_BG
PROCESS_LISTBOX_SELECTED_ITEM_FG = SELECT_LISTBOX_SELECTED_ITEM_FG

PROCESS_LISTBOX_FEATURE_STATUS_BG = FILTER_LISTBOX_FEATURE_STATUS_BG
PROCESS_LISTBOX_FEATURE_STATUS_FG = FILTER_LISTBOX_FEATURE_STATUS_FG


PROCESS_LABEL_OVERLAY_BG = DISABLED_ORANGE
...
FILTER_BTN_BG_ACTIVE = ACTIVE_COLOR

PROCESS_BTN_BG_ACTIVE = ACTIVE_COLOR
PROCESS_BTN_FG_ACTIVE = FG_COLOR
