...
class OOTO_Miner:
    ...
    def configureTestTabElements(self):
        testFrame = uiTest.OOTO_Miner(self.Tabs_t3)
        self.testTabParentFrame = testFrame.getMainFrame() # LabelFrame(self.Tabs_t3, bd = 0)
    ...
    def configureChiTabElements(self, parentFrame):
        chiFrame = uiTest.OOTO_Miner(parentFrame)
